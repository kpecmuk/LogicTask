...
class XNum {
    ...
    XNum() {
        ...
        map.put("a1", new Variable(1));
        map.put("a2", new Variable(1));
        map.put("a3", new Variable(1));
        ...
        map.put("c1", new Variable(1));
        map.put("c3", new Variable(1));
        map.put("c4", new Variable(1));
